...
public class MapleStatEffect implements Serializable {
    ...
    private Point lt, rb;
    private int expBuff, itemup, mesoup, cashup, berserk, illusion, booster, berserk2, cp, nuffSkill,exp;
    private byte level;
    ...
    private static MapleStatEffect loadFromData(final MapleData source, final int sourceid, final boolean skill, final boolean overTime, final byte level) {
        ...
        if (skill) { // hack because we can't get from the datafile...
            switch (sourceid) {
				...
				case 21120002:
					statups.add(new Pair<MapleBuffStat, Integer>(MapleBuffStat.FINAL_MEL_ATTACK, ret.x));
					break;
                case 13101002:
            ...
            default:
                if (isMorph() || isPirateMorph()) {
                    ...
                    if (mountid != 0 && mountid2 != 0) {
                        ...
                        applyto.getClient().sendPacket(MaplePacketCreator.giveMount(mountid2, sourceid, stat));
